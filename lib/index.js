                    ...
                    callbacks : {
                      ...
                      progressBar : function() {
                          ...
                          button
                            ...
                            .click(function() {
                              mpmetrics.track('play', {'id': id, 'context': 'main'});
                    ...
                    callbacks : {
                      progressBar : function() {
                          ...
                          button
                            .text(sprintf(this.buttons.play[0], this.name))
                            .click(function() {
                              mpmetrics.track('play', {'id': id, 'context': 'album'});
                              $(this).text(sprintf(that.buttons.play[1], that.name));
                              _.values(bt.torrent.get(that.url).file.all())[0].open();
                              // XXX The following callback should be triggered by above open().
                              if ('function' === typeof that.callbacks.openFile) {
						...
						callbacks : {
						  ...
						  progressBar : function() {
							  ...
							  button
								.text(sprintf(this.buttons.play[0], this.name))
								.click(function() {
                                  mpmetrics.track('play', {'id': albumID, 'context': 'artist'});
								  $(this).text(sprintf(that.buttons.play[1], that.name));
								  _.values(bt.torrent.get(that.url).file.all())[0].open();
								  // XXX The following callback should be triggered by above open().
								  if ('function' === typeof that.callbacks.openFile) {
                    ...
                    callbacks : {
                      ...
                      progressBar : function() {
                          ...
                          button
                            .text(sprintf(this.buttons.play[0], this.name))
                            .click(function() {
                              mpmetrics.track('play', {'id': id, 'context': 'search'});
                              $(this).text(sprintf(that.buttons.play[1], that.name));
                              _.values(bt.torrent.get(that.url).file.all())[0].open();
                              // XXX The following callback should be triggered by above open().
                              if ('function' === typeof that.callbacks.openFile) {
